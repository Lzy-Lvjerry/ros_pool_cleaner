...
echo_and_run cd "/home/lvjerry/poolCleaner_ws/src/ros-geometry2/tf2_sensor_msgs"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/lvjerry/poolCleaner_ws/build/ros-geometry2/tf2_sensor_msgs" \
    install \
    --root="${DESTDIR-/}" \
