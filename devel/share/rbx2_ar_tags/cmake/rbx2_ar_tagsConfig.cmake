...
if("TRUE" STREQUAL "TRUE")
  set(rbx2_ar_tags_SOURCE_PREFIX /home/lvjerry/poolCleaner_ws/src/ar_tags)
  set(rbx2_ar_tags_DEVEL_PREFIX /home/lvjerry/poolCleaner_ws/devel)
  ...
  set(rbx2_ar_tags_INSTALL_PREFIX /home/lvjerry/poolCleaner_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rbx2_ar_tags' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lvjerry/poolCleaner_ws/src/ar_tags/${idir}'.  ${_report}")
    endif()
